...
export default function ContactUs() {
  ...
  return (
    <main className="bg-white font-sans text-gray-900 min-h-screen">
      ...
      {/* ━━ FOOTER ━━ */}
      <footer className="bg-gray-900 py-12 flex flex-col items-center">
        <div className="flex items-end mb-2">
          {["a", "p"].map((l) => (
            <span
              key={l}
              className="text-white font-light"
              style={{ fontFamily: "Georgia, serif", fontSize: "2.6rem", lineHeight: 1 }}
            >{l}</span>
          ))}
          <div className="relative flex items-center justify-center" style={{ width: "3rem", height: "3rem" }}>
          ...
          <span
            ...
            style={{ fontSize: "1.6rem", marginBottom: "1.1rem" }}
          >+</span>
        </div>
        <p
          className="text-gray-500 tracking-[0.28em] uppercase mb-6"
