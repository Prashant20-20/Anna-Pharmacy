...
export default function AboutUs() {
  return (
    <main className="bg-white font-sans text-gray-900">
      ...
      {/* ━━ PAGE TITLE ━━ */}
      <section className="bg-[#3a3a3a] px-6 md:px-16 lg:px-32 py-10 md:py-14">
        <p className="text-xs text-gray-400 tracking-[0.2em] uppercase mb-2">Pharmacy background</p>
        <h1 className="text-4xl md:text-5xl text-white font-light" style={{ fontFamily: "Georgia, serif" }}>
          About <span className="font-extralight italic">Us</span>
        </h1>
      </section>
